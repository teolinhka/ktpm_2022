...
public class Update_Delete_Task_Company extends AppCompatActivity {
    ...
    EditText edit_text,edit_nametask,edit_modules;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edit_modules= findViewById(R.id.input_mod);
        ...
        edit_text.setText(getIntent().getStringExtra("SeriNumber"));
        ...
        edit_modules.setText(getIntent().getStringExtra("Model"));
    ...
    public void UpdateTask(){
        ...
        mDatabase.child("Task").child(getIntent().getStringExtra("Id")).child("TimeBuy").setValue(dateTextStart.getText().toString());
        mDatabase.child("Task").child(getIntent().getStringExtra("Id")).child("Warranty").setValue(dateTextEnd.getText().toString());
        ...
        mDatabase.child("Task").child(getIntent().getStringExtra("Id")).child("Seri").setValue(edit_text.getText().toString());
        mDatabase.child("Task").child(getIntent().getStringExtra("Id")).child("Status").setValue(Sttus.getText().toString());
        mDatabase.child("Task").child(getIntent().getStringExtra("Id")).child("Module").setValue(edit_modules.getText().toString());
